        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-6 bg-white border-b border-gray-200 flex flex-col items-center">
                <form class="mt-6" action="{{ route('alumnos.store') }}" method="POST">
                    ...
                    <button type="submit"
                        class="ml-28 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-semibold rounded-lg text-sm px-4 py-2 mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">
                        Insertar
                    </button>
                </form>
            </div>
